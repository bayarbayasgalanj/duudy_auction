...
class Website(models.Model):
    ...
    publish_deposit_error = fields.Boolean(string='Deposit Error',
                                default= 1)
    publish_deposit_error_msz = fields.Text(string='Deposit Error Message',
                                default= u'Барьцаа хэтэрсэн байна!',
                                translate=True)    
