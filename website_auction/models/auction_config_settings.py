...
class WebsiteAuctionConfigSettings(models.Model):
    ...
    #####MW DARAMAA
    default_publish_deposit_error = fields.Boolean(string='Deposit Error',
                                help="Show Unexpected Error Message on unknown Error. " ,
                                related="website_id.publish_deposit_error", readonly=False)
    default_publish_deposit_error_msz = fields.Text(string='Deposit Error Message',
                                translate=True,
                                related="website_id.publish_deposit_error_msz", readonly=False)
