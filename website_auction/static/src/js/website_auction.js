	...
	$(document).ready(function(){
		...
		if(window.location.pathname.includes("/shop/product")){
			...
			if (span1){
				...
				try {
					var new_date = moment(time.str_to_datetime(date)).format('DD-MMM-YYYY,h:mmA');
